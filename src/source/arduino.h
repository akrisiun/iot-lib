...
//
DllExport inline void delayMicroseconds(unsigned int us)
{
    LARGE_INTEGER us64;
    us64.QuadPart = us;
...
// specified as parameter.
//
DllExport inline void delay(unsigned long ms)
{
...
DllExport inline unsigned long millis(void)
{
...
DllExport inline unsigned long micros(void)
{
...
//  digitalWrite(15, 0);
//
DllExport inline void digitalWrite(unsigned int pin, unsigned int state)
{
...
//
DllExport inline int digitalRead(int pin)
{
    ULONG readData = 0;
...
\sa analogReadResolution
*/
DllExport inline int analogRead(int pin)
{
    ULONG value;
    ULONG bits;
    ULONG ioPin;
...
*/
DllExport inline void analogReadResolution(int bits)
{
    if ((bits < 1) || (bits > 32))
    {
...
*/
DllExport inline void analogReference(int type)
{
    if (type != DEFAULT)
    {
...
*/
DllExport inline void analogWrite(unsigned int pin, unsigned int dutyCycle)
{
...
*/
DllExport inline void analogWriteResolution(int bits)
{
    if ((bits < 1) || (bits > 32))
    {
...
*/
DllExport inline void pinMode(unsigned int pin, unsigned int mode)
{
    switch (mode)
    {
    case INPUT:
...
DllExport inline uint8_t shiftIn(uint8_t data_pin_, uint8_t clock_pin_, uint8_t bit_order_)
{
    uint8_t buffer(0);
...
DllExport inline void shiftOut(uint8_t data_pin_, uint8_t clock_pin_, uint8_t bit_order_, uint8_t byte_)
{
